...
1. Download the reference FASTA (NC_006853.1) from NCBI efetch with curl:
   `curl -s "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi?db=nuccore&id=NC_006853.1&rettype=fasta&retmode=text" > data/ref.fa`
